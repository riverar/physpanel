...
pub unsafe fn RtlPublishWnfStateData(
    ...
    windows_link::link!("ntdll.dll" "system" fn RtlPublishWnfStateData(statename : WNF_STATE_NAME, typeid : *const WNF_TYPE_ID, buffer : *const core::ffi::c_void, length : u32, explicitscope : *const core::ffi::c_void) -> windows::Win32::Foundation:: NTSTATUS);
    unsafe {
...
pub unsafe fn RtlQueryWnfStateData(
    ...
    windows_link::link!("ntdll.dll" "system" fn RtlQueryWnfStateData(changestamp : *mut u32, statename : WNF_STATE_NAME, callback : PWNF_USER_CALLBACK, callbackcontext : *const core::ffi::c_void, typeid : *const WNF_TYPE_ID) -> windows::Win32::Foundation:: NTSTATUS);
    unsafe {
